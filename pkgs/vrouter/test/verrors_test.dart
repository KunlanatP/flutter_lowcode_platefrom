...
main() {
  group('VError', () {
    testWidgets('InvalidPushVError', (tester) async {
      ...
      final vRouter = VRouter(
        ...
        key: vRouterKey,
        routes: [
          VWidget(path: '/settings', widget: const Text('VWidget1')),
        ],
      );
    ...
    testWidgets("UnknownUrlVError", (tester) async {
    ...
    testWidgets("NotFoundErrorNameResult", (tester) async {
      runZonedGuarded(() async {
        final vRouterKey = GlobalKey<VRouterState>();
      ...
      runZonedGuarded(() async {
        ...
        await tester.pumpWidget(
          VRouter(
            ...
            routes: [
              VWidget(path: '/', widget: const Text('VWidget1')),
              VWidget(path: '/:id', widget: const Text('VWidget2'), name: 'id'),
            ],
          ),
        );
    ...
    testWidgets("NullPathErrorNameResult", (tester) async {
      runZonedGuarded(() async {
        final vRouterKey = GlobalKey<VRouterState>();
        ...
        await tester.pumpWidget(
          VRouter(
            ...
            routes: [
              VWidget(path: '/', widget: const Text('VWidget1')),
              VWidget(path: null, widget: const Text('VWidget2'), name: 'id'),
            ],
          ),
        );
    ...
    testWidgets("PathParamsPopErrors", (tester) async {
      runZonedGuarded(() async {
        final vRouterKey = GlobalKey<VRouterState>();
