...
main() {
  group('VRouter', () {
    testWidgets('VGuard beforeLeave', (tester) async {
    ...
    testWidgets('VGuard beforeUpdate', (tester) async {
      final vRouterKey = GlobalKey<VRouterState>();
    ...
    testWidgets('VGuard beforeEnter', (tester) async {
      final vRouterKey = GlobalKey<VRouterState>();
    ...
    testWidgets('VWidgetGuard voidAfterUpdate', (tester) async {
      var count = 0;
      await tester.pumpWidget(
        VRouter(
          routes: [
