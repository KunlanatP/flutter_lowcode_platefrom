...
import 'package:oneweb_widgets/utils/utils.dart';
...
class OWVideoPlayer extends StatefulWidget {
  const OWVideoPlayer({
    Key? key,
    required this.path,
...
class _FlutterFlowVideoPlayerState extends State<OWVideoPlayer>
    with RouteAware {
  ...
  @override
  void didUpdateWidget(OWVideoPlayer oldWidget) {
